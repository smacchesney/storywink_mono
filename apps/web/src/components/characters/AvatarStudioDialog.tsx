    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1.5 pr-6">
        <input
          ...
          className={cn(
            'w-full rounded-lg border border-black/10 px-2 py-1 font-playful text-base text-[#1a1a1a] placeholder:text-gray-400 focus:border-coral focus:ring-1 focus:ring-coral focus:outline-none disabled:bg-transparent',
