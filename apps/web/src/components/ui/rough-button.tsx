    ...
    return () => {
      if (svgRef.current) {
        drawnElements.forEach((element) => {
          try {
            if (svgRef.current?.contains(element)) svgRef.current.removeChild(element);
          } catch (e) {}
        });
      }
    };
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        size={size}
        className={cn(
          'relative z-10 border-none bg-transparent hover:bg-transparent focus:bg-transparent active:bg-transparent',
