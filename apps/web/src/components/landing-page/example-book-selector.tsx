...
const ExampleBookSelector: React.FC<ExampleBookSelectorProps> = ({
  ...
  const chip = (book: ExampleBook) => (
    <span className="inline-flex max-w-full items-center justify-center rounded-full border-2 border-coral/30 bg-white px-2.5 py-0.5 text-center font-playful text-[11px] leading-snug whitespace-normal text-ink shadow-sm md:text-xs">
      {t('chipLabel', {
        ...
        <div className="flex items-start justify-center gap-3 px-2">
          {books.map((book, index) => (
            <button
              ...
              className={cn(
                'flex w-[30vw] max-w-[140px] cursor-pointer flex-col items-center gap-2 rounded-xl focus-visible:ring-2 focus-visible:ring-[var(--coral-primary)] focus-visible:ring-offset-2 focus-visible:outline-none',
          ...
          {books.map((book, index) => {
            ...
            return (
              <motion.button
                key={book.id}
                onClick={() => onSelectBook(book)}
                className="relative flex cursor-pointer flex-col items-center gap-2 rounded-xl focus-visible:ring-2 focus-visible:ring-[var(--coral-primary)] focus-visible:ring-offset-2 focus-visible:outline-none"
              ...
              >
                <div
                  className="relative overflow-hidden rounded-xl border-2 border-transparent bg-[var(--cream-yellow)] shadow-lg transition-shadow duration-300 hover:border-[var(--coral-primary)]/30 hover:shadow-xl"
