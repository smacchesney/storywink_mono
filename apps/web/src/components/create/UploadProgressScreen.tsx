  ...
  return (
    <div className="fixed inset-0 bg-white flex flex-col items-center justify-center z-50">
      ...
      <div className="isolate">
        <TextShimmerWave
          className="text-lg md:text-xl font-excalifont [--base-color:#374151] [--base-gradient-color:var(--coral-primary)] dark:[--base-color:#D1D5DB] dark:[--base-gradient-color:var(--coral-primary)]"
          duration={1}
          spread={1}
          zDistance={1}
          scaleDistance={1.1}
