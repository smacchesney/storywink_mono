...
describe('PEOPLE_SOURCE_HIERARCHY arbitration content', () => {
  ...
  it("gives pose, clothing, and composition to the page's photo", () => {
    expect(PEOPLE_SOURCE_HIERARCHY).toMatch(/pose, body position, clothing/);
