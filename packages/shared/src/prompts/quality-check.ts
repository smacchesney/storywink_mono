    ...
    pageResults: {
      ...
      items: {
        ...
        properties: {
          ...
          passed: { type: 'boolean' },
          characterConsistencyScore: { type: 'integer' },
          styleConsistencyScore: { type: 'integer' },
          overallScore: { type: 'integer' },
          issues: { type: 'array', items: { type: 'string' } },
          suggestedPromptAdditions: { type: 'string', nullable: true },
        },
        required: ['pageNumber', 'passed', 'characterConsistencyScore', 'styleConsistencyScore', 'overallScore', 'issues'],
      },
    },
  },
