 ...
 */
export function createIllustrationPrompt(opts) {
...
export function buildContentPreservationSection() {
...
export function buildTextSection(isTitlePage, text, bookTitle) {
    if (isTitlePage) {
