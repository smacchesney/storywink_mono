...
// ----------------------------------
export const STORY_GENERATION_SYSTEM_PROMPT = "You are an expert children's picture‑book author for toddlers (ages 2‑5). Your task is to write engaging story text for a personalised picture book based on the user's photos and inputs.";
// ----------------------------------
// STORY GENERATION – VISION PROMPT
// ----------------------------------
export function createVisionStoryGenerationPrompt(input) {
    const msg = [];
    // ---------- CONFIG ----------
    msg.push({
        type: 'text',
    ...
    const nonWinkifyExtra = '- Output **ONLY** valid JSON mapping page numbers to text. Example: { "1": "Leo and Mommy went to the park." }';
    msg.push({
        type: 'text',
