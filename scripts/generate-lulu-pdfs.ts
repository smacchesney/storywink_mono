...
function illustrationPage(imageUrl: string | null): string {
  ...
  return pageDiv(
    '',
    `<img src="${optimizeForPrint(imageUrl)}" style="display:block;width:100%;height:100%;object-fit:cover;object-position:center" />`,
  );
}
...
const BOOK: BookData = {
  ...
  pages: [
    {
      pageNumber: 1,
      assetId: 'cmm6imee60004my0dbab34qfv',
      text: null,
      generatedImageUrl:
    ...
    {
      pageNumber: 2,
      assetId: 'cmm6imeen0006my0dzc2m1bt8',
    ...
    {
      pageNumber: 3,
      assetId: 'cmm6imeg2000emy0dqlerpy17',
    ...
    {
      pageNumber: 4,
      assetId: 'cmm6imeey0008my0di8j7oxpa',
    ...
    {
      pageNumber: 5,
      assetId: 'cmm6imefp000cmy0d7ref0445',
    ...
    {
      pageNumber: 6,
      assetId: 'cmm6imefc000amy0d6w6ou7mq',
    ...
    {
      pageNumber: 7,
      assetId: 'cmm6imege000gmy0d3t9z7gf9',
    ...
    {
      pageNumber: 8,
      assetId: 'cmm6imeh3000kmy0d1qzs2haz',
    ...
    {
      pageNumber: 9,
      assetId: 'cmm6imegr000imy0d8ajvo8qa',
    ...
    {
      pageNumber: 10,
      assetId: 'cmm6imehf000mmy0dzothnvkk',
    ...
    {
      pageNumber: 11,
      assetId: 'cmm6imehs000omy0dbj34qc4t',
    ...
    {
      pageNumber: 12,
      assetId: 'cmm6imei5000qmy0duuoahz47',
    ...
    {
      pageNumber: 13,
      assetId: 'cmm6imeii000smy0drmdw53xw',
    ...
    {
      pageNumber: 14,
      assetId: 'cmm6imeiv000umy0ddbno7yjx',
...
async function main() {
  ...
  await page.setViewport({
    width: Math.round(PAGE_W * DPI),
    height: Math.round(PAGE_H * DPI),
    deviceScaleFactor: 1,
  });
  ...
  console.log(
    `Interior PDF saved: ${interiorPath} (${(interiorPdf.length / 1024 / 1024).toFixed(1)} MB)`,
  );
  ...
  await page.setViewport({
    width: Math.round(COVER_W * DPI),
    height: Math.round(COVER_H * DPI),
    deviceScaleFactor: 1,
  });
